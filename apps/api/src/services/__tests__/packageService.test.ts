...
describe("PackageService", () => {
  ...
  describe("createPackage", () => {
    ...
    it("should throw error if customer not found", async () => {
      ...
      await expect(
        packageService.createPackage(mockPackageData),
      ).rejects.toThrow(
        new AppError("Customer not found", "CUSTOMER_NOT_FOUND", 404),
      );
    });
    ...
    it("should validate required fields", async () => {
      ...
      await expect(packageService.createPackage(invalidData)).rejects.toThrow(
        new AppError("Description is required", "INVALID_DESCRIPTION", 400),
      );
    });
    ...
    it("should validate coordinates", async () => {
      ...
      await expect(packageService.createPackage(invalidData)).rejects.toThrow(
        new AppError("Invalid pickup latitude", "INVALID_COORDINATES", 400),
      );
    });
    ...
    it("should validate package size", async () => {
      ...
      await expect(packageService.createPackage(invalidData)).rejects.toThrow(
        new AppError("Invalid package size", "INVALID_SIZE", 400),
      );
    });
  });
  ...
  describe("updatePackageStatus", () => {
    ...
    it("should validate status transitions", async () => {
      ...
      await expect(
        packageService.updatePackageStatus("package-123", updateData),
      ).rejects.toThrow(
        new AppError(
    ...
    it("should throw error if package not found", async () => {
      ...
      await expect(
        packageService.updatePackageStatus("nonexistent", updateData),
      ).rejects.toThrow(
        new AppError("Package not found", "PACKAGE_NOT_FOUND", 404),
      );
    });
  ...
  describe("deletePackage", () => {
    ...
    it("should prevent unauthorized deletion", async () => {
      ...
      await expect(
        packageService.deletePackage("package-123", "other-user-123"),
      ).rejects.toThrow(
        new AppError(
    ...
    it("should prevent deletion of non-pending packages", async () => {
      ...
      await expect(
        packageService.deletePackage("package-123", "customer-123"),
      ).rejects.toThrow(
        new AppError(
