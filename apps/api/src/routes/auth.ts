...
router.post(
  ...
  requireAuth,
  authController.createDriverProfile.bind(authController),
);
router.get(
  "/me",
  requireAuth,
...
router.post(
  ...
  validateRequest,
  authController.resendPhoneVerificationOtp.bind(authController),
);
router.post(
  "/request-account-recovery",
  accountRecoveryValidation,
  validateRequest,
  authController.requestAccountRecovery.bind(authController),
);
router.post(
  "/confirm-account-recovery",
  accountRecoveryConfirmValidation,
  validateRequest,
  authController.confirmAccountRecovery.bind(authController),
);
...
router.post(
  ...
  validateRequest,
  authController.registerFcmToken.bind(authController),
);
router.post(
  "/fcm-token/remove",
  requireAuth,
  [body("fcmToken").notEmpty().withMessage("FCM token is required")],
  validateRequest,
  authController.removeFcmToken.bind(authController),
);
