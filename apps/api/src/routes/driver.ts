...
const createDriverProfileValidation = [
  body('carRegistration').notEmpty().withMessage('Car registration is required'),
  ...
  body('vehicleCapacity').optional().isString().withMessage('Vehicle capacity must be a string')
];
