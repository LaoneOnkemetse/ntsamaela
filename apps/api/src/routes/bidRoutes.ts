...
router.post(
  ...
  [
    ...
    body("amount")
      .isFloat({ min: 0 })
      .withMessage("Valid bid amount is required"),
    body("message")
      .optional()
      .isString()
...
router.get("/", requireAuth, (req: any, res: any) =>
  bidController.getBids(req, res),
);

router.get("/pending", requireAuth, (req, res) =>
  bidController.getPendingBids(req, res),
);
...
router.get("/package/:packageId", requireAuth, (req, res) =>
