...
router.get(
  "/verifications",
  adminController.getVerificationRequests.bind(adminController),
);
router.get(
  "/verifications/:id",
  adminController.getVerificationRequest.bind(adminController),
);
router.put(
...
router.put(
  "/users/:id",
  adminController.updateUserProfile.bind(adminController),
);
router.put(
  "/users/:id/status",
...
router.post(
  "/users/:id/notify",
  adminController.sendNotificationToUser.bind(adminController),
);
...
router.get(
  ...
  adminController.getTransactionAnalytics.bind(adminController),
);
router.get(
  "/transactions/:id",
  adminController.getTransaction.bind(adminController),
);
router.post(
  "/transactions/:id/retry",
  adminController.retryFailedTransaction.bind(adminController),
);
router.post(
  "/transactions/:id/refund",
  adminController.refundTransaction.bind(adminController),
);
...
router.get(
  "/analytics/realtime",
  adminController.getRealTimeMetrics.bind(adminController),
);
router.post(
  "/analytics/export",
  adminController.exportAnalytics.bind(adminController),
);
...
router.get(
  "/system/alerts",
  adminController.getSystemAlerts.bind(adminController),
);
router.put(
...
router.post(
  "/bulk-action",
  adminController.performBulkAction.bind(adminController),
);
