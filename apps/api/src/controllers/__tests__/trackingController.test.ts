...
describe("TrackingController", () => {
  ...
  describe("createTrackingUpdate", () => {
    it("should create tracking update successfully", async () => {
      ...
      await trackingController.createTrackingUpdate(
  ...
  describe("getPackageTracking", () => {
    it("should get package tracking successfully", async () => {
      ...
      await trackingController.getPackageTracking(
        mockReq as unknown as Request,
        mockRes as Response,
      );

      expect(mockRealtimeService.getPackageTracking).toHaveBeenCalledWith(
        "package123",
      );
  ...
  describe("updatePackageLocation", () => {
    it("should update package location successfully", async () => {
      ...
      await trackingController.updatePackageLocation(
        mockReq as unknown as Request,
        mockRes as Response,
      );
  ...
  describe("startDelivery", () => {
    it("should start delivery successfully", async () => {
      ...
      await trackingController.startDelivery(
        mockReq as unknown as Request,
        mockRes as Response,
      );
      ...
      expect(mockRealtimeService.notifyDeliveryStarted).toHaveBeenCalledWith(
        "package123",
        "driver123",
      );
      expect(mockRes.status).toHaveBeenCalledWith(200);
  ...
  describe("completeDelivery", () => {
    it("should complete delivery successfully", async () => {
      const deliveryData = {
        // Don't pass notes to use the default message
      };
      ...
      await trackingController.completeDelivery(
        mockReq as unknown as Request,
        mockRes as Response,
      );
