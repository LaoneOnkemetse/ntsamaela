...
describe("ChatController", () => {
  ...
  beforeEach(() => {
    ...
    mockRealtimeService.getChatRooms.mockResolvedValue([]);
  });
  ...
  describe("getChatMessages", () => {
    it("should get chat messages successfully", async () => {
      ...
      expect(mockRealtimeService.getChatMessages).toHaveBeenCalledWith(
        "chat123",
        50,
        0,
      );
  ...
  describe("markMessageAsRead", () => {
    it("should mark message as read successfully", async () => {
      ...
      await chatController.markMessageAsRead(
        mockReq as unknown as Request,
        mockRes as Response,
      );

      expect(mockRealtimeService.markMessageAsRead).toHaveBeenCalledWith(
        "msg123",
      );
      expect(mockRes.status).toHaveBeenCalledWith(200);
      expect(mockRes.json).toHaveBeenCalledWith({
