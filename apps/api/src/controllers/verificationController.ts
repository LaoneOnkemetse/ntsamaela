...
export class VerificationController {
  async submitVerification(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      const frontImageUrl = (
        await cloudStorageService.uploadPackageImage(
          files.frontImage[0],
          userId,
  ...
  async testDocumentAuthenticity(req: Request, res: Response) {
    try {
      ...
      const result = await verificationService.testDocumentAuthenticity(
        imageBase64,
        documentType,
      );
  ...
  async testFacialRecognition(req: Request, res: Response) {
    try {
      ...
      const result = await verificationService.testFacialRecognition(
        selfieImageBase64,
        documentImageBase64,
      );
  ...
  async testOCRExtraction(req: Request, res: Response) {
    try {
      ...
      const result = await verificationService.testOCRExtraction(
        imageBase64,
        documentType,
      );
