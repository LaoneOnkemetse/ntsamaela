...
export default function Verifications() {
  ...
  return (
    <Box sx={{ p: 3 }}>
              ...
              {verifications.length === 0 ? (
                ...
                verifications.map((verification: any) => (
                  <TableRow key={verification.id} hover>
                    ...
                    <TableCell>{verification.documentType || 'Unknown'}</TableCell>
                    <TableCell>
                      <Chip
      ...
      >
        <DialogTitle>
          Review Verification - {selectedVerification?.user?.firstName} {selectedVerification?.user?.lastName}
        </DialogTitle>
        <DialogContent>
          {selectedVerification && (
            <Box sx={{ mt: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary" gutterBottom>
                <strong>Submitted:</strong> {selectedVerification.submittedAt 
